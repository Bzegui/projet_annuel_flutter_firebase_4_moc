  ...
  group('AppAuthBlocObserver', () {
    ...
    test(
      ...
      overridePrint(() {
        ...
        AppAuthBlocObserver().onEvent(bloc, event);
    ...
    test(
      ...
      overridePrint(() {
        ...
        AppAuthBlocObserver().onError(bloc, error, stackTrace);
    ...
    test(
      ...
      overridePrint(() {
        ...
        AppAuthBlocObserver().onChange(cubit, change);
    ...
    test(
      ...
      overridePrint(() {
        ...
        AppAuthBlocObserver().onTransition(bloc, transition);
